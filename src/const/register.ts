...
export const RegistrationForm: Record<string, IRegistrationField> = {
  ...
  password_confirmation: {
    label: 'auth.register.password_confirmation',
    name: 'password_confirmation',
    type: 'password',
    placeholder: 'auth.register.password_confirmation_placeholder',
    required: true,
    textContentType: 'password',
    secureTextEntry: true,
  },
  ...
  impairmentLevel: {
    label: 'auth.register.impairmentLevel',
    name: 'impairmentLevel',
    type: 'link',
    placeholder: 'auth.register.impairmentLevel_placeholder',
    required: false,
    href: '/impairment',
